...
export function Contact() {
  ...
  return (
    <Section id="contact" className="border-t border-default">
      ...
      <div className="overflow-hidden rounded-xl border border-default bg-elev">
        <div className="grid lg:grid-cols-2">
          ...
          >
            <p className="text-2xl font-semibold tracking-tight sm:text-3xl" aria-hidden="true">
              Get in touch
            </p>
          ...
          {/* Right — contact details + education */}
...
function ContactRow({ icon, label, value, href, variants }: ContactRowProps) {
